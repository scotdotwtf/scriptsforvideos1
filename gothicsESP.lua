...
do
    ...
    crosshair_settings.color = Color3.fromRGB(110, 143, 201)
...
do
    ...
    tracers_settings.enemycolor = Color3.fromRGB(75, 108, 162) -- 238,38,37, 255,0,13, 255,7,58
    tracers_settings.teamcolor = Color3.fromRGB(255, 255, 255) -- 121,255,97, 57,255,20
    tracers_settings.visiblecolor = Color3.fromRGB(110, 143, 201)
...
do
    ...
    esp_settings.teamcolor = Color3.fromRGB(255,255,255) -- 121,255,97, 57,255,20
    esp_settings.enemycolor = Color3.fromRGB(75, 108, 162) -- 238,38,37, 255,0,13, 255,7,58
    esp_settings.visiblecolor = Color3.fromRGB(110, 143, 201) -- 0, 141, 255
...
do
    ...
    boxes_settings.teamcolor = Color3.fromRGB(255, 255, 255) -- 121,255,97,  57,255,20
    boxes_settings.enemycolor = Color3.fromRGB(75, 108, 162) -- 238,38,37, 255,0,13, 255,7,58
    boxes_settings.visiblecolor = Color3.fromRGB(110, 143, 201)
    ...
    boxes_settings.color = Color3.fromRGB(75, 108, 162)
    ...
    function visuals.step()
        ...
        if credits == nil then
            credits = newdrawing("Text", {
                Text = "ESP - gxthsoldiers"; -- yes now be happy this is free
        ...
        if aimbot.enabled and aimbot.fovenabled and visuals.enabled then
            ...
            if circle == nil then
                circle = newdrawing("Circle", {
                    ...
                    Color = Color3.fromRGB(110, 143, 201),
